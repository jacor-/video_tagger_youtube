...
###
class CIFAR100OriginalDataset(object):
    @staticmethod
    ...
    def __init__(self):
        CIFAR100OriginalDataset.download_dataset(st.path_cifar_images + "/cifar-100-python.tar.gz")
        train_set, test_set, meta = CIFAR100OriginalDataset.load_data(st.path_cifar_images + "/cifar-100-python")

        test_set_x, test_set_y = CIFAR100OriginalDataset.shared_dataset((test_set[0], CIFAR100OriginalDataset.oneHotEncoding(test_set[1])))
        train_set_x, train_set_y = CIFAR100OriginalDataset.shared_dataset((train_set[0], CIFAR100OriginalDataset.oneHotEncoding(train_set[1])))
