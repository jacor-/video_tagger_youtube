...
class VGG16Network(object):
    def __init__(self, batch_size):
        # Some parameters for this specific network
        self.weights_url = "https://s3.amazonaws.com/lasagne/recipes/pretrained/imagenet/vgg16.pkl"
        self.weights_filename = settings.path_pretrained_weights + "/vgg16.pkl"

        # We build the model
        self.net = self.build_model(batch_size)
        ...
        self.mean_image = params['mean value']
